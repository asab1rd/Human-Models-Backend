...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    ...
    budget: Schema.Attribute.Enumeration<
      ['under5k', 'from5kTo15k', 'from15kTo50k', 'over50k', 'undisclosed']
    >;
    ...
    inquiryType: Schema.Attribute.Enumeration<
      ['booking', 'collaboration', 'press', 'general']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    legalLinks: Schema.Attribute.Component<'navigation.menu-item', true>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::footer.footer'>;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'navigation.footer-section', true>;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Dynamic homepage with modular sections';
...
export interface ApiModelApplicationModelApplication
  extends Struct.CollectionTypeSchema {
  collectionName: 'model_applications';
  info: {
    description: 'Model application submissions';
  ...
  attributes: {
    availability: Schema.Attribute.Enumeration<
      ['full-time', 'part-time', 'freelance', 'student']
    > &
      Schema.Attribute.Required;
    ...
    experience: Schema.Attribute.Enumeration<
      ['none', 'amateur', 'semi-professional', 'professional']
    > &
      Schema.Attribute.Required;
    firstName: Schema.Attribute.String & Schema.Attribute.Required;
    gender: Schema.Attribute.Enumeration<['male', 'female', 'non-binary']> &
      Schema.Attribute.Required;
    lastName: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::model-application.model-application'
    > &
      Schema.Attribute.Private;
    measurements: Schema.Attribute.Component<'model.measurements', false> &
      Schema.Attribute.Required;
    nationality: Schema.Attribute.String & Schema.Attribute.Required;
    notes: Schema.Attribute.RichText;
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    portfolioPhotos: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 10;
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    socialLinks: Schema.Attribute.Component<'model.socials', false>;
    status: Schema.Attribute.Enumeration<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    willingToTravel: Schema.Attribute.Boolean &
...
export interface ApiModelModel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    board: Schema.Attribute.Enumeration<
      ['women', 'men', 'new-faces', 'curve', 'commercial']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    city: Schema.Attribute.Enumeration<
      ['Paris', 'London', 'Milan', 'New York', 'Los Angeles', 'Sydney', 'Tokyo']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    compCardPdf: Schema.Attribute.Media<'files'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    portfolioImages: Schema.Attribute.Media<'images' | 'videos', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    socials: Schema.Attribute.Component<'model.socials', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workExperience: Schema.Attribute.Component<'model.work-item', true>;
  };
}
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    menuItems: Schema.Attribute.Component<'navigation.menu-item', true> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    showLanguageSwitch: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Static pages with dynamic sections';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiPhotoPhoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['digitals', 'portfolio', 'polaroid', 'campaign', 'editorial', 'runway']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    shootDate: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiWorkItemWorkItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Model work and campaigns';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credits: Schema.Attribute.Component<'work.credits', false>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::model-application.model-application': ApiModelApplicationModelApplication;
